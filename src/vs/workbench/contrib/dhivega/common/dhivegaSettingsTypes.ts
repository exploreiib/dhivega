...
import { DhivegaSettingsState } from './dhivegaSettingsService.js'
...
export type DhivegaStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
type CommonProviderSettings = {
	...
	models: DhivegaStatefulModelInfo[],
}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Dhivega. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: DhivegaStatefulModelInfo[] } => {
	return {
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	anthropic: {
		...
		models: modelInfoOfDefaultModelNames(['claude-3-5-sonnet-20241022', 'claude-3-opus-20240229', 'claude-3-sonnet-20240229', 'claude-3-haiku-20240307']).models,
		apiKey: '',
		endpoint: undefined,
		region: undefined,
		project: undefined,
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: DhivegaSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: DhivegaSettingsState) => {
