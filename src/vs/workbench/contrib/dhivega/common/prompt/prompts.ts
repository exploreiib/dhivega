...
import { ChatMode } from '../dhivegaSettingsTypes.js';
...
export const dhivegaPrefixAndSuffix = ({ fullFileStr, startLine, endLine }: { fullFileStr: string, startLine: number, endLine: number }) => {
