...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './dhivegaSettingsTypes.js';
...
export type DhivegaStaticModelInfo = { // not stateful
	// Dhivega uses the information below to know how to handle each model.
...
type DhivegaStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: DhivegaStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<DhivegaStaticModelInfo>) => (DhivegaStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies DhivegaStaticModelInfo
...
} as const satisfies { [s: string]: Partial<DhivegaStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: DhivegaStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<DhivegaStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: DhivegaStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: DhivegaStaticModelInfo }

const anthropicSettings: DhivegaStaticProviderInfo = {
...
const openAISettings: DhivegaStaticProviderInfo = {
...
const xAISettings: DhivegaStaticProviderInfo = {
...
const geminiSettings: DhivegaStaticProviderInfo = {
...
const deepseekSettings: DhivegaStaticProviderInfo = {
...
const mistralSettings: DhivegaStaticProviderInfo = {
...
const groqSettings: DhivegaStaticProviderInfo = {
...
} as const satisfies Record<string, DhivegaStaticModelInfo>
const googleVertexSettings: DhivegaStaticProviderInfo = {
...
const microsoftAzureSettings: DhivegaStaticProviderInfo = {
...
const awsBedrockSettings: DhivegaStaticProviderInfo = {
...
const vLLMSettings: DhivegaStaticProviderInfo = {
...
const lmStudioSettings: DhivegaStaticProviderInfo = {
...
const ollamaSettings: DhivegaStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: DhivegaStaticProviderInfo = {
...
const liteLLMSettings: DhivegaStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: DhivegaStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: DhivegaStaticProviderInfo } = {
