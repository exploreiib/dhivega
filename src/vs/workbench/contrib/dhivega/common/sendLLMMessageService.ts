...
export class LLMMessageService extends Disposable implements ILLMMessageService {
	...
	constructor(
		...
		this.channel = this.mainProcessService.getChannel('dhivega-channel-llmMessage')
	...
	sendLLMMessage(params: ServiceSendLLMMessageParams) {
		...
		if (modelSelection === null) {
			const message = `Please add a provider in Dhivega's Settings.`
		...
		const { settingsOfProvider, } = this.dhivegaSettingsService.state
