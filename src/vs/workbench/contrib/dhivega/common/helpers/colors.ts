...
// gets converted to --vscode-dhivega-greenBG, see void.css, asCssVariable
registerColor('dhivega.greenBG', configOfBG(acceptBG), '', true);
registerColor('dhivega.redBG', configOfBG(rejectBG), '', true);
registerColor('dhivega.sweepBG', configOfBG(sweepBG), '', true);
registerColor('dhivega.highlightBG', configOfBG(highlightBG), '', true);
registerColor('dhivega.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
