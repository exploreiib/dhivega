...
export class MetricsService implements IMetricsService {
	...
	constructor(
		...
		this.metricsService = ProxyChannel.toService<IMetricsService>(mainProcessService.getChannel('dhivega-channel-metrics'));
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'dhivegaDebugInfo',
			f1: true,
			title: localize2('dhivegaMetricsDebug', 'Dhivega: Log Debug Info'),
		});
	}
