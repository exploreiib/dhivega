...
import { mountDhivegaOnboarding } from './react/out/dhivega-onboarding/index.js'
...
export class OnboardingContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.dhivegaOnboarding';
	...
	private initialize(): void {
		...
		if (workbench) {
			...
			this.instantiationService.invokeFunction((accessor: ServicesAccessor) => {
				const result = mountDhivegaOnboarding(onboardingContainer, accessor);
