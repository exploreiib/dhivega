...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/dhivega/common/dhivegaSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { DhivegaSettingsState } from '../../../../../../../workbench/contrib/dhivega/common/dhivegaSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/dhivega/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/dhivega/common/refreshModelService.js';
import { IDhivegaSettingsService } from '../../../../../../../workbench/contrib/dhivega/common/dhivegaSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/dhivega/browser/extensionTransferService.js'
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		dhivegaCommandBarService: accessor.get(IDhivegaCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, dhivegaCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		dhivegaCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		dhivegaCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IDhivegaCommandBarService: accessor.get(IDhivegaCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Dhivega useAccessor was called before _registerServices!`)
	}
