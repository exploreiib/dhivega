...
export const DhivegaTooltip = () => {
	...
	return (
		...
		// use native colors so we don't have to worry about @@dhivega-scope styles
		// --dhivega-bg-1: var(--vscode-input-background);
		// --dhivega-bg-1-alt: var(--vscode-badge-background);
		// --dhivega-bg-2: var(--vscode-sideBar-background);
		// --dhivega-bg-2-alt: color-mix(in srgb, var(--vscode-sideBar-background) 30%, var(--vscode-editor-background) 70%);
		// --dhivega-bg-3: var(--vscode-editor-background);

		// --dhivega-fg-0: color-mix(in srgb, var(--vscode-tab-activeForeground) 90%, black 10%);
		// --dhivega-fg-1: var(--vscode-editor-foreground);
		// --dhivega-fg-2: var(--vscode-input-foreground);
		// --dhivega-fg-3: var(--vscode-input-placeholderForeground);
		// /* --dhivega-fg-4: var(--vscode-tab-inactiveForeground); */
		// --dhivega-fg-4: var(--vscode-list-deemphasizedForeground);

		// --dhivega-warning: var(--vscode-charts-yellow);

		// --dhivega-border-1: var(--vscode-commandCenter-activeBorder);
		// --dhivega-border-2: var(--vscode-commandCenter-border);
		// --dhivega-border-3: var(--vscode-commandCenter-inactiveBorder);
		// --dhivega-border-4: var(--vscode-editorGroup-border);
		...
		<>
			<style>
				...
				#dhivega-tooltip-orange {
					background-color: #F6762A;
					color: white;
				}

				#dhivega-tooltip-green {
					background-color: #228B22;
					color: white;
				}

				#dhivega-tooltip-ollama-settings, #dhivega-tooltip-provider-info {
					background-color: var(--vscode-editor-background);
					color: var(--vscode-input-foreground);
				}
