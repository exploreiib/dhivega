	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--dhivega-fg-1)',
						'--tw-prose-headings': 'var(--dhivega-fg-1)',
						'--tw-prose-lead': 'var(--dhivega-fg-2)',
						'--tw-prose-links': 'var(--dhivega-link-color)',
						'--tw-prose-bold': 'var(--dhivega-fg-1)',
						'--tw-prose-counters': 'var(--dhivega-fg-3)',
						'--tw-prose-bullets': 'var(--dhivega-fg-3)',
						'--tw-prose-hr': 'var(--dhivega-border-4)',
						'--tw-prose-quotes': 'var(--dhivega-fg-1)',
						'--tw-prose-quote-borders': 'var(--dhivega-border-2)',
						'--tw-prose-captions': 'var(--dhivega-fg-3)',
						'--tw-prose-code': 'var(--dhivega-fg-0)',
						'--tw-prose-pre-code': 'var(--dhivega-fg-0)',
						'--tw-prose-pre-bg': 'var(--dhivega-bg-1)',
						'--tw-prose-th-borders': 'var(--dhivega-border-4)',
						'--tw-prose-td-borders': 'var(--dhivega-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'dhivega-bg-1': 'var(--dhivega-bg-1)',
				'dhivega-bg-1-alt': 'var(--dhivega-bg-1-alt)',
				'dhivega-bg-2': 'var(--dhivega-bg-2)',
				'dhivega-bg-2-alt': 'var(--dhivega-bg-2-alt)',
				'dhivega-bg-2-hover': 'var(--dhivega-bg-2-hover)',
				'dhivega-bg-3': 'var(--dhivega-bg-3)',


				'dhivega-fg-0': 'var(--dhivega-fg-0)',
				'dhivega-fg-1': 'var(--dhivega-fg-1)',
				'dhivega-fg-2': 'var(--dhivega-fg-2)',
				'dhivega-fg-3': 'var(--dhivega-fg-3)',
				// 'dhivega-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'dhivega-fg-4': 'var(--dhivega-fg-4)',

				'dhivega-warning': 'var(--dhivega-warning)',

				'dhivega-border-1': 'var(--dhivega-border-1)',
				'dhivega-border-2': 'var(--dhivega-border-2)',
				'dhivega-border-3': 'var(--dhivega-border-3)',
				'dhivega-border-4': 'var(--dhivega-border-4)',

				'dhivega-ring-color': 'var(--dhivega-ring-color)',
				'dhivega-link-color': 'var(--dhivega-link-color)',
