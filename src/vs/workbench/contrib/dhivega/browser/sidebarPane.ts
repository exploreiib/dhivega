...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the Dhivega chat view.'));

// called VIEWLET_ID in other places for some reason
export const DHIVEGA_VIEW_CONTAINER_ID = 'workbench.view.dhivega'
export const DHIVEGA_VIEW_ID = DHIVEGA_VIEW_CONTAINER_ID

// Register view container
const viewContainerRegistry = Registry.as<IViewContainersRegistry>(ViewContainerExtensions.ViewContainersRegistry);
const container = viewContainerRegistry.registerViewContainer({
	id: DHIVEGA_VIEW_CONTAINER_ID,
	title: nls.localize2('dhivegaContainer', 'Chat'), // this is used to say "Dhivega" (Ctrl + L)
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, [DHIVEGA_VIEW_CONTAINER_ID, {
...
viewsRegistry.registerViews([{
	...
	name: nls.localize2('dhivegaChat', ''), // this says ... : CHAT
...
// open sidebar
export const DHIVEGA_OPEN_SIDEBAR_ACTION_ID = 'dhivega.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: DHIVEGA_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open Dhivega Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupDhivegaSidebar';
	constructor(
		@ICommandService private readonly commandService: ICommandService,
	) {
		this.commandService.executeCommand(DHIVEGA_OPEN_SIDEBAR_ACTION_ID)
	}
}
