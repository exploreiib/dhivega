...
import { Diff, DiffArea, DhivegaFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getDhivegaFileSnapshot(uri: URI): DhivegaFileSnapshot;
	restoreDhivegaFileSnapshot(uri: URI, snapshot: DhivegaFileSnapshot): void;
}
