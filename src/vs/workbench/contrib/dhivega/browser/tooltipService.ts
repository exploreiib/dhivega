...
import { mountDhivegaTooltip } from './react/out/dhivega-tooltip/index.js';
...
export class TooltipContribution extends Disposable implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.dhivegaTooltip';
	...
	private initializeTooltip(): void {
		...
		if (workbench) {
			...
			this.instantiationService.invokeFunction((accessor: ServicesAccessor) => {
				const result = mountDhivegaTooltip(tooltipContainer, accessor);
