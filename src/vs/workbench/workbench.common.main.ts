...
//#region --- Dhivega
import './contrib/dhivega/browser/dhivega.contribution.js'; // Dhivega added this
//#endregion
...
// Chat
// Dhivega - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
