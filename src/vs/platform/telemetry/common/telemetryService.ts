...
Dhivega separately records basic usage like the number of messages people are sending. If you'd like to disable Dhivega metrics, you may do so in Dhivega's Settings.
`;
